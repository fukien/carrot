...
//        }
        ...
        for(int j=0;j<A_tuple->meta->fieldNum;j++){
            ...
            if(item->data[cnt]==0) item->data[cnt]=new Byte[A_tuple->column[j].field->len];
...
//            if(flag) continue;
            ...
            if(item->data[cnt]==0) item->data[cnt]=new Byte[B_tuple->column[j].field->len];
...
//        }
        ...
        for(int j=0;j<A_item->fieldNum;j++){
            ...
            if(item->data[cnt]==0) item->data[cnt]=new Byte[A_item->len[j]];
...
//            if(flag) continue;
            ...
            if(item->data[cnt]==0) item->data[cnt]=new Byte[B_item->len[j]];
